...
% plot(vert_all,u(vert_all),'LineWidth',1.8,'LineStyle','-','Marker','o','MarkerIndices',1:4:M,'DisplayName','local')
...
for k = 1:length(del)
    ...
    U = Stiff\ff;
    U = U/Scale;
    plot(vert(nf),U(nn1+(1:nn-2)),'LineWidth',1.8,'LineStyle','-','DisplayName',['\delta=' num2str(delta)]); 
    legend
